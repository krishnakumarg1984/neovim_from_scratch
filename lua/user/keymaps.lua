...
-- keymap("n", "<C-Left>", ":vertical resize -2<CR>", opts_noremapsilent)
-- keymap("n", "<C-Right>", ":vertical resize +2<CR>", opts_noremapsilent)
-- -- )))

-- -- Navigate buffers (((
-- keymap("n", "<S-l>", ":bnext<CR>", opts_noremapsilent)
-- keymap("n", "<S-h>", ":bprevious<CR>", opts_noremapsilent)
-- -- )))
